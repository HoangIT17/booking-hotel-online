          ...
          <div className={style.leftBanner}>
            ...
            <div className={style.bannerText}>
              ...
              <p className={style.bannerDesc}>
                Đăng nhập để tiếp tục đặt phòng, quản lý đặt phòng hoặc truy cập
                không gian làm việc của khách sạn.
              </p>
            </div>
          </div>
          ...
          <div className={style.rightForm}>
            <div className={style.formHeader}>
              ...
              <p className={style.formSubtitle}>
                Đăng nhập để tận hưởng trải nghiệm đặt phòng nhanh chóng và tiện
                lợi với LuxeStay.
              </p>
            </div>
