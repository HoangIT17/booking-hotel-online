...
const READ_ONLY_BOOKING_STATUSES = ["CANCELLED", "CONFIRMED", "CHECKED_IN", "CHECKED_OUT", "CHECKOUT", "CHECKEDOUT", "REFUNDED"];
                      ...
                      <td className={styles.expandedTableCell} colSpan={9}>
                        ...
                        >
                          ...
                          <div className={styles.buttonRow}>
                            ...
                            {REVIEWABLE_BOOKING_STATUSES.includes(booking.bookingStatus?.toUpperCase?.()) && (
                              <button
                                className={styles.reviewButton}
                                type="button"
                                onClick={() => !booking.hasReview && openReviewModal(booking)}
                                disabled={booking.hasReview}
                              >
                                {booking.hasReview ? "Đã đánh giá" : "Write a review"}
                              </button>
                            )}
                          </div>
                        </section>
