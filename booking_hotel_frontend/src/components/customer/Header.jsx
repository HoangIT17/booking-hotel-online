...
const Header = () => {
    ...
    const displayUsername = user?.fullName || user?.username || 'Khách hàng';
    ...
    const onLogout = () => {
        // Gọi action clear state Redux & LocalStorage
                    ...
                    {isAuthenticated ? (
                        <div className="dropdown ms-3">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end shadow border-0 mt-3 p-0" aria-labelledby="userDropdown" style={{ minWidth: '250px', overflow: 'hidden' }}>
                                ...
                                <div className="p-2">
                                    <li>
                                        <Link className="dropdown-item d-flex align-items-center gap-3 py-2 rounded" to="/book-history">
                                            <i className="fa-solid fa-clock-rotate-left text-info" style={{ width: '18px', textAlign: 'center' }}></i>
                                            <span>Lịch sử đặt phòng</span>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="dropdown-item d-flex align-items-center gap-3 py-2 rounded" to="/history-reviews">
